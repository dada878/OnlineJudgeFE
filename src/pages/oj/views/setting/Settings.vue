...
<style lang="less" scoped>
  ...
  // === dark mode theme for settings page ===
  .ivu-card {
  ...
  .avatar-editor .avatar-container .avatar {
    box-shadow: 0 0 4px #156DD7;
    border: 2px solid #156DD7;
  }

  .avatar-editor .avatar-container .avatar-mask {
  ...
  .menu .ivu-menu,
  .menu .ivu-menu-item,
  .menu .ivu-menu-item-selected,
  .menu .ivu-menu-item-active {
    color: #e6f0ff !important;
  }
